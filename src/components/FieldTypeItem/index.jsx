...
import { FIELD_TYPE_ITEM_INPUT_TYPE, FIELD_TYPES_ICONS } from '../../constants/fieldTypes';
    ...
    return (
      <Grid
        ...
        <Grid item container xs={10} alignItems="center" wrap="nowrap">
          <CrossIcon
            className={
              isMouseHover && !isEditModeEnabled ? classes.crossIcon : classes.hiddenCrossIcon
            }
          />
        ...
        <Grid item container xs={2} justifyContent="flex-end" alignItems="center">
          <CustomTooltip
            title="Edit"
            className={(!isMouseHover || isEditModeEnabled) && classes.hiddenAttributeButton}
            ariaLabel="edit"
