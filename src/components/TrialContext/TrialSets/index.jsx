...
import { TRIAL_SETS_DASH, TRIAL_SETS, TRIALS, TRIAL_SET_MUTATION } from '../../../constants/base';
    ...
    return (
      <React.Fragment key={trialSet.key}>
        <StyledTableCell
          ...
          onClick={() =>
            history.push(
              `/experiments/${match.params.id}/${TRIAL_SETS_DASH}/${trialSet.key}/${TRIALS}`
            )
          }>
          {trialSet.name}
        </StyledTableCell>
        ...
        <StyledTableCell
          ...
          {trialSet.description}
        </StyledTableCell>
        <StyledTableCell align="right">
          <CustomTooltip title="Clone" ariaLabel="clone" onClick={() => this.clone(trialSet)}>
            <CloneIcon />
          </CustomTooltip>
          <CustomTooltip
            title="Edit"
...
export default compose(withRouter, withApollo, withStyles(styles))(TrialSets);
