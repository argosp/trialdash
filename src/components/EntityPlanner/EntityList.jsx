...
export const EntityList = ({
  ...
  return (
    <div
      style={{ overflow: "auto", height: "340px", display: "block" }}
        ...
        {entities.map((devType) =>
          devType.items.map((dev, index) => {
            ...
            const entityLocation =
              prop && prop.val ? prop.val.coordinates : undefined;
            const isEntityOnLayer =
              entityLocation && prop.val.name === layerChosen;
            ...
            return (
              <EntityRow
                ...
                onClick={(e) => {
                  handleSelectionClick(index, e.shiftKey);
                }}
