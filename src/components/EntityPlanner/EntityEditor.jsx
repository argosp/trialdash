...
export const EntityEditor = ({
  ...
  const [selectedType, setSelectedType] = React.useState(
    entities.length ? entities[0].name : ""
  );
  ...
  const shapeOptions = [
    ...
    },
    {
      ...
      toPositions: (points, amount) =>
        resamplePolyline(splineCurve(points, 100), amount),
    },
    {
      name: "Arc",
      toLine: (points) => {
      ...
      toPositions: (points, amount) =>
        resamplePolyline(arcCurveFromPoints(points, 400), amount),
    },
    {
      name: "Rect",
  ...
  const distanceInMeters = () => {
    const row = (experimentDataMaps || []).find(
      (r) => r.imageName === layerChosen
    );
        ...
        {!entities.length ? null : (
          <>
            ...
            <EntityList
              ...
              removeEntitiesLocations={(indices) =>
                setEntities(changeLocations(selectedType, indices))
              }
              layerChosen={layerChosen}
            />
          </>
