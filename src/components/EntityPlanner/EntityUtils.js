export const getTypeLocationProp = (entitiesType) => {
  const locationProp = entitiesType.properties.find(
    (prop) => prop.type === "location"
  );
  if (!locationProp || !locationProp.key || locationProp.key === "")
    return undefined;
...
export const changeEntityLocation = (
  entity,
  entitiesType,
  newLocation,
  locationKind
