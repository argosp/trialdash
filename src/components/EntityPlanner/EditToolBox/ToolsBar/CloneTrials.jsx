...
const CloneTrials = ({ classes }) => {
  ...
  return (
    <Box className={classes.cloneTrialsContainer} flexDirection={'column'}>
      {/* mapping on trials */}
      <Box className={classes.cloneTrialsContainer} flexDirection={'row'}>
      ...
      <Box
        ...
        <Box component="span" display="flex" alignItems="center" gridGap={4}>
          <Typography component="span">
            <Box fontSize={12}>Design</Box>
          </Typography>
          <AntSwitch checked={trialsState.trial1} onChange={handleChange} name="trial1" />
