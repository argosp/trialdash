  ...
  return (
    <Grid container className={classes.tool}>
      <Grid item className="toolItem">
        <TextField id="x-input" label="x" onChange={onChange} name="x" defaultValue={pos.x} InputLabelProps={{ shrink: true }} />
        <TextField id="y-input" label="y" onChange={onChange} name="y" defaultValue={pos.y} InputLabelProps={{ shrink: true }} />
      </Grid>
