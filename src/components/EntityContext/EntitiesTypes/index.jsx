    ...
    return (
      <React.Fragment key={entitiesType.key}>
        <StyledTableCell
          ...
          onClick={() =>
            history.push(
              `/experiments/${match.params.id}/${ENTITIES_TYPES_DASH}/${entitiesType.key}/${ENTITIES}`
            )
          }>
          {entitiesType.name}
        </StyledTableCell>
        <StyledTableCell
          ...
          {entitiesType.properties.length}
        </StyledTableCell>
        <StyledTableCell
          className={classes.tableCell}
          align="left"
          ...
          {entitiesType.numberOfEntities}
        </StyledTableCell>
        <StyledTableCell align="right">
          <CustomTooltip title="Clone" ariaLabel="clone" onClick={() => this.clone(entitiesType)}>
            <CloneIcon />
          </CustomTooltip>
          <CustomTooltip
            title="Edit"
        ...
        {this.state.isEditModeEnabled ? (
          ...
          <>
            <ContentHeader
              ...
              addButtonHandler={() =>
                history.push(`/experiments/${match.params.id}/add-entities-type`)
              }
            />
            <ContentTable
...
export default compose(withRouter, withApollo, withStyles(styles))(EntitiesTypes);
