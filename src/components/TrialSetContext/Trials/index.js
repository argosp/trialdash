...
class TrialSets extends React.Component {
    renderTableRow = trial => (
      <React.Fragment key={trial.id}>
        ...
        <StyledTableCell align="left">{trial.devices ? trial.devices.length : 0}</StyledTableCell>
        <StyledTableCell align="left">Release radius</StyledTableCell>
        <StyledTableCell align="left">Release type</StyledTableCell>
        <StyledTableCell align="left"><Link to="/">view location</Link></StyledTableCell>
        ...
        <StyledTableCell align="right">
          ...
          <Tooltip title="Open trial" className={this.props.classes.arrowButton}>
            <IconButton
              aria-label="open trial"
            >
              <ArrowForwardIosIcon />
            </IconButton>
          </Tooltip>
