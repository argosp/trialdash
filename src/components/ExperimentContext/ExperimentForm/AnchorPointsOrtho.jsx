...
export const AnchorPointsOrtho = ({
  anchorLatLng,
  horizontalLng,
  verticalLat,
  setAnchorLatLng,
  ...
  return (
    <>
      ...
      <MarkedPoint
        ...
        locationToShow={`(${round9(horizontalLng)}, ${round9(
          anchorLatLng.lat
        )}) in meters<br/>(${round9(horizontalX)}, ${round9(
          anchorXY.y
        )}) in pixels`}
      ...
      ></MarkedPoint>
      <DashedPolyline
        positions={[verticalPoint, anchorPoint, horizontalPoint]}
      ></DashedPolyline>
    </>
  );
};
