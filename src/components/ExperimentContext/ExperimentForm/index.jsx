...
class ExperimentForm extends React.Component {
  ...
  render() {
    ...
    const { formObject, isStartDatePickerOpen, isEndDatePickerOpen, confirmOpen } = this.state;
                ...
                <Grid item xs={5} ref={this.startDatePickerRef}>
                  <DatePicker
                    ...
                    TextFieldComponent={(props) => (
                      <CustomInput
                        {...props}
                        onClick={() => this.setIsDatePickerOpen('isStartDatePickerOpen', true)}
                        inputProps={{
                          endAdornment: (
                            <InputAdornment position="end">
                              <CustomTooltip
                                ...
                                onClick={() =>
                                  this.setIsDatePickerOpen('isStartDatePickerOpen', true)
                                }>
                                <DateIcon />
                              </CustomTooltip>
                            </InputAdornment>
                ...
                <Grid item xs={5} ref={this.endDatePickerRef}>
                  <DatePicker
                    ...
                    TextFieldComponent={(props) => (
                      <CustomInput
                        {...props}
                        onClick={() => this.setIsDatePickerOpen('isEndDatePickerOpen', true)}
                        inputProps={{
                          endAdornment: (
                            <InputAdornment position="end">
                              <CustomTooltip
