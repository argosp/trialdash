...
function CloneEntitiesDialog(
  ...
  const concatEntities = () => {
    ...
    if (selectedEntitiesTypeKey)
      ent = getEntitiesByEntitiesTypeKey(selectedTrial, selectedEntitiesTypeKey);
  ...
  return (
    <>
      <Dialog open={open} onClose={() => setOpen(false)} aria-labelledby="customized-dialog-title">
        <DialogTitle
                ...
                <StyledListItem
                  ...
                  onClick={(e) => {
                    ...
                    setEntitiesTypesOfSelectedTrial(
                      getEntitiesTypeArrayFromSelectedTrial(trial, entitiesTypes)
                    );
                  }}>
              ...
              <FormControl component="fieldset" style={{ display: 'flex' }}>
                ...
                <RadioGroup
                  ...
                  <FormControlLabel
                    value="deploy"
                    disabled={
                      !selectedTrial || (selectedTrial && !selectedTrial.deployedEntities.length)
                    }
                    control={<Radio />}
                    label="deploy"
                  />
